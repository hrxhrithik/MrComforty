...
public interface BookingDao extends JpaRepository<Booking, Integer> {
	...
	@Query(value = "select customer_id from booking where booking_id=?", nativeQuery = true)
	public int getCustomerId(int book_id);

	@Query(value = "select service_provider_id from booking where booking_id=?", nativeQuery = true)
	public int getProviderId(int book_id);
